...
const ITEMS: NavItem[] = [
  ...
  { href: "/cong-viec", label: "Công việc", icon: ClipboardList, roles: ["ADMIN", "MANAGER", "MARKETING", "EC"], phase: "P3" },
  { href: "/kpi", label: "KPI", icon: Target, roles: ["ADMIN", "MANAGER", "MARKETING", "EC", "VIEWER"], phase: "P3" },
  { href: "/sale-kit", label: "Sale Enablement", icon: Sparkles, roles: ["ADMIN", "MANAGER", "MARKETING", "EC"], phase: "P3" },
  { href: "/bao-cao", label: "Báo cáo", icon: BarChart3, roles: ["ADMIN", "MANAGER"], phase: "P2" },
